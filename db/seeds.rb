...
Game.create(title: :MemoDeck, description: "A game where you have to remember every moves you and your opponent made before seeing it happen!", image: "memoDeck.png", );
